...
export default function AboutMe() {
    return (
      <div>
        ...
        <Card style={{ backgroundSize:'cover', height: '90vh', color: 'black', fontSize: 'large',fontWeight: 'bold', background: '#6B8F71', display: 'flex', justifyContent:'space-around', marginTop: 30 }}>
          <Card.Body>
